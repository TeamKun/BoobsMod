...
import net.kunmc.lab.boobsmod.Boobsmod;
...
public class MessageHandlerOnClient {
  ...
  private static void processMessage(ClientWorld worldClient, TargetEffectMessageToClient message)
  {
    ...
    //LogManager.getLogger().info("MHOC:"+ Boobsmod.noob);
    Boobsmod.PlayersBasts.put(message.getUUID(),new float[]{message.getBast(),0.0f,0.0f});
