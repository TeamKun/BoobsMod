package net.kunmc.lab.boobsmod.usefultools;
...
public final class RenderTypeHelper {
  ...
  static {
    ...
    renderState = RenderType.State.	func_228694_a_()
            .func_228720_a_(new RenderState.LineState(OptionalDouble.of(1)))
            .func_228718_a_(PROJECTION_LAYERING)
            .func_228726_a_(NO_TRANSPARENCY)
            .func_228727_a_(WRITE_TO_DEPTH_AND_COLOR)
            .func_228728_a_(AFFECTS_OUTLINE);
    MBE_LINE_DEPTH_WRITING_ON = RenderType.func_228632_a_("mbe_line_1_depth_writing_on",
    ...
    renderState = RenderType.State.	func_228694_a_()
            ...
            .func_228726_a_(NO_TRANSPARENCY)
            .func_228727_a_(WRITE_TO_DEPTH_AND_COLOR)
            .func_228715_a_(NO_DEPTH_TEST)
            .func_228728_a_(AFFECTS_OUTLINE);
    MBE_LINE_NO_DEPTH_TEST = RenderType.func_228632_a_("mbe_line_1_no_depth_test",
            DefaultVertexFormats.POSITION_COLOR, GL11.GL_LINES, INITIAL_BUFFER_SIZE, renderState);
    ...
    renderState = RenderType.State.	func_228694_a_()
            ...
            .func_228727_a_(WRITE_TO_DEPTH_AND_COLOR)
            .func_228728_a_(AFFECTS_OUTLINE);
    MBE_TRIANGLES_NO_TEXTURE = RenderType.func_228632_a_("mbe_triangles_no_texture",
